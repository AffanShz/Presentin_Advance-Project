...
<body class="bg-gray-100 p-8">
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Edit Master Tutorial</h1>
        ...
        <form action="{{ url('/master-tutorial/' . $tutorial->id) }}" method="POST">
            ...
            @method('PUT') <div class="mb-4">
                <label class="block text-gray-700 font-bold mb-2">Judul Tutorial</label>
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-500 mt-1">*Email pembuat tidak dapat diubah</p>
            </div>
